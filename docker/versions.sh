...
#
export CTRL_OODS_GIT=tags/5.0.1
#
...
#
export LSST_STACK_VERSION=7-stack-lsst_distrib-w_2022_06
...
export DM_ATARCHIVER_CONTAINER=${DM_ATARCHIVER_VERSION}_base_${DM_CSC_BASE_VERSION}_${DEPLOY_SUFFIX}_a
export DM_ATCONTROLLER_CONTAINER=${DM_ATARCHIVER_CONTAINER}

export DM_CCARCHIVER_CONTAINER=${DM_CCARCHIVER_VERSION}_base_${DM_CSC_BASE_VERSION}_${DEPLOY_SUFFIX}_a
