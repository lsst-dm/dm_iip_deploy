...
export STACK_VERSION="w_2022_15"
...
export OODS_CONTAINER_VERSION=${CTRL_OODS_VERSION}-${CYCLE_TAG}-${STACK_VERSION}
export TEST_OODS_CONTAINER_VERSION=test-${OODS_CONTAINER_VERSION}
